...
//build SQL based on the genre selection. @TODO
//$sql="SELECT * FROM dvd_view WHERE genre_id=$genreID AND label_id=$labelID";
...
<content>
    <table>
        ...
        while($currentrow = mysqli_fetch_array($results)){
            ...
            $sql_TEST = "SELECT * FROM saved_organizations 
                  WHERE organization_id =".$currentrow['organization_id']." AND username='".$_SESSION["username"]."'";
            ...
            if(mysqli_num_rows($testResults)==0){
                echo "<td class='save'><a href='save.php?organization_name=" . $currentrow['organization_name'] .
                    "&organization_id=" . $currentrow['organization_id'] . "&type_id=" . $currentrow['type_id'] .
                    "&function_id=" . $currentrow['function_id'] .
                    "&involvement_id=" . $currentrow['involvement_id'] .
    ...
    <div>
        <a href="org_results2.php?organization_name=<?php echo $name; ?>&type_id=<?php echo $typeId; ?>&function_id=<?php echo $functionId; ?>&involvement_id=<?php echo $involvementId; ?>&email=<?php echo $emailId; ?>&page=<?php echo ($first_page); ?>">
            [<< First]
        </a>
        <a href="org_results2.php?organization_name=<?php echo $name; ?>&type_id=<?php echo $typeId; ?>&function_id=<?php echo $functionId; ?>&involvement_id=<?php echo $involvementId; ?>&email=<?php echo $emailId; ?>&page=<?php echo ($current_page-1); ?>">
            [< Previous]
        </a>
        ...
        <a href="org_results2.php?organization_name=<?php echo $name; ?>&type_id=<?php echo $typeId; ?>&function_id=<?php echo $functionId; ?>&involvement_id=<?php echo $involvementId; ?>&email=<?php echo $emailId; ?>&page=<?php echo $last_page; ?>">
            [Last >>]
        </a>
    </div>
</content>
